...
$sub_folder = 'cards/';//change to 'widgets' or 'sprockets' etc.
...
switch(THIS_PAGE){
    case 'index.php':
        $config->title = 'Home';
        $config->banner = 'Home';
        $config->slogan = 'The Home Page';
    break;
    case 'contact.php':
        $config->title = 'Contact';
        $config->banner = 'Contact';
        $config->slogan = 'How To Contact Us';
    break;
    case 'daily.php':
        $config->title = 'Daily';
        $config->banner = 'Daily';
        $config->slogan = 'A Daily Reactive Page';
    break;
    case 'card_list.php':
        $config->title = 'Cards';
        $config->banner = 'Cards';
        $config->slogan = 'List of Cards';
    break;
    case 'card_view.php':
        $config->title = 'Card';
        $config->banner = 'Card';
